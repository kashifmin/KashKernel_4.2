...
#CUSTOM_HAL_IMGSENSOR = ov12830_mipi_raw ov12830_mipi_raw_truly ov5647_mipi_raw ov5648_mipi_raw  #ov8825_mipi_raw s5k8aayx_mipi_yuv
#CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov12830_mipi_raw_truly
...
#CUSTOM_KERNEL_IMGSENSOR = ov12830_mipi_raw ov12830_mipi_raw_truly ov5647_mipi_raw ov5648_mipi_raw
...
#CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = ov12830_mipi_raw_truly
...
#CUSTOM_KERNEL_TOUCHPANEL = ft5406 ekth3248
#CUSTOM_KERNEL_WIFI = 
...
BUILD_LK = yes
BUILD_MTK_SDK = 
BUILD_PRELOADER = no #yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = S9311_MP_IN_MMX_19_flasher_user
...
CUSTOM_HAL_IMGSENSOR = imx135_mipi_raw imx135_mipi_raw_truly ov5647_mipi_raw ov5648_mipi_raw
CUSTOM_HAL_LENS = fm50af fm50af_truly dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = imx135_mipi_raw_truly
CUSTOM_HAL_MAIN_BACKUP_LENS = fm50af_truly
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = ov5648_mipi_raw
...
CUSTOM_KERNEL_GYROSCOPE = bmg160
CUSTOM_KERNEL_HDMI = 
CUSTOM_KERNEL_HEADSET = accdet
CUSTOM_KERNEL_IMGSENSOR = imx135_mipi_raw imx135_mipi_raw_truly ov5647_mipi_raw ov5648_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = r63311_fhd_dsi_vdo_sharp
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = fm50af fm50af_truly dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = akm8963
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_MAIN2_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = imx135_mipi_raw_truly
CUSTOM_KERNEL_MAIN_BACKUP_LENS = fm50af_truly
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx135_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = fm50af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6320pmic_spk
CUSTOM_KERNEL_SSW = ssw_generic
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = ov5648_mipi_raw
...
GEMINI = yes
GMT_FOTA_SUPPORT = yes # dengyanjun 2013 0718
...
INTERNAL_BUILD_VERNO = S9311_MP_IN_MMX_13_27
...
MTK_MULTI_STORAGE_SUPPORT = no  #display only one storage change by panchenjun
...
MTK_PRODUCT_LOCALES = en_US en_IN de_DE de_CH fr_FR in_ID it_IT pt_BR tr_TR ldpi mdpi hdpi xhdpi xxhdpi
...
MTK_SNS_KAIXIN_APP = no #yes
MTK_SNS_RENREN_APP = no #yes
MTK_SNS_SINAWEIBO_APP = no #yes
MTK_SNS_SINAWEIBO_TEST = no
MTK_SNS_SUPPORT = yes
MTK_SNS_TWITTER_APP = no #yes
...
MTK_THEMEMANAGER_APP = yes #no dengyanjun 20130710
...
TINNO_UI_ACCESS_CAMERA = yes
TINNO_UI_CAMERA_SUPPORT = yes
TINNO_USER_ROOT = no
TN_ONECLEAN = no
TUI_APP_BACKUPRESTORE = no
TUI_APP_BROWSER = no
TUI_APP_CALCULATOR = no
TUI_APP_CALENDAR = no
TUI_APP_CELLCONNSERVICE = no
TUI_APP_CONTACTS = no
TUI_APP_DESKCLOCK = no
TUI_APP_EMAIL = no
TUI_APP_FILEMANAGER = no
TUI_APP_FMRADIO = no
TUI_APP_GALLERY2 = no
TUI_APP_LATINIME = no
TUI_APP_LAUNCHER2 = no
TUI_APP_LIVEPICKER = no
TUI_APP_MMS = no
TUI_APP_MUSIC = no
TUI_APP_MUSICFX = no
TUI_APP_OOBE = no
TUI_APP_PACKAGEINSTALLER = no
TUI_APP_PHONE = no
TUI_APP_PHOTOTABLE = no
TUI_APP_POWERSAVING = no
TUI_APP_RINGTONE = no
TUI_APP_SCHEDULEPOWERONOFF = no
TUI_APP_SETTINGS = no
TUI_APP_SOUNDRECORDER = no
TUI_APP_STK1 = no
TUI_APP_SYSTEMFONT = no #yes #add system font
TUI_APP_SYSTEMUI = no #no #yes
TUI_APP_THEMESETTINGS = no
TUI_APP_TINNOFLOW = no
TUI_APP_TINNOLED = no
TUI_APP_TINNOWEATHERWIDGET = no
TUI_APP_TPUPGRADE = no
TUI_APP_VIDEOPLAYER = no
TUI_APP_VIDEOPLAYERWIDGET = no
TUI_APP_VOICEUNLOCK = no
TUI_SUPPORT = no
UC_BROWSER = no
