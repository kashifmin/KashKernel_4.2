...
static unsigned int g_max_freq_by_ptp = DVFS_F0_1; /*added by kashifmin: Overclock to 1.5GHz */
...
static bool mt_cpufreq_max_freq_overdrive = true; /*added by kashifmin: Overclock to 1.5GHz */
