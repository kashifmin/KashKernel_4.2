...
#if defined(OV8825_TRULY_MIPI_RAW)
    RAW_INFO(OV8825_TRULY_SENSOR_ID, SENSOR_DRVNAME_OV8826_TRULY_MIPI_RAW, CAM_CALGetCalData), 
#endif
#if defined(OV8826_MIPI_RAW)
    RAW_INFO(OV8826_SENSOR_ID, SENSOR_DRVNAME_OV8826_MIPI_RAW, CAM_CALGetCalData), 
#endif
