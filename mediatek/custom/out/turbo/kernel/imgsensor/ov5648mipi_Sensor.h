...
#define RG_TYPICAL 0x58 //88  //golden sample R/G ratio //LINE <> <DATE20130510> <sunny ov5647 R/G B/G TYPICAL> wupingzhou
#define BG_TYPICAL 0x5e //94  //golden sample B/G ratio//LINE <> <DATE20130510> <sunny ov5647 R/G B/G TYPICAL> wupingzhou


#endif
//export functions
static UINT32 OV5647MIPIOpen(void);
static UINT32 OV5647MIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
static UINT32 OV5647MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
static UINT32 OV5647MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
