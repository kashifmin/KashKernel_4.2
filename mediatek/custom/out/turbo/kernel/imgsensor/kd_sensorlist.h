...
UINT32 OV5648MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//LINE <> <DATE20130508> <add sensor:sunny ov5647> wupingzhou
...
#endif
#if defined(OV5648_MIPI_RAW)//LINE <> <DATE20130508> <add sensor:sunny ov5647> wupingzhou
    {OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648MIPI_RAW, OV5648MIPISensorInit}, 
#endif
...
//LINE<JIRA_ID><DATE20130523><IMX135>zenghaihui
#if defined(IMX135_MIPI_RAW_TRULY)
    {IMX135_SENSOR_ID_TRULY, SENSOR_DRVNAME_IMX135_MIPI_RAW_TRULY, IMX135_MIPI_RAW_SensorInit_truly}, 
#endif
