...
//LINE<JIRA_ID><DATE20130524><IMX135>zenghaihui
#define CAMERA_IMX135_EN_PIN  149
...
u32 pinSet[3][8] = {
    ...
    else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_IMX135_MIPI_RAW,currSensorName))) //LINE<JIRA_ID><DATE20130523><IMX135>zenghaihui
    {
    ...
    mdelay(1);
        ...
        // 1.05V
        mt_set_gpio_mode(CAMERA_IMX135_EN_PIN, 0);
        mt_set_gpio_dir(CAMERA_IMX135_EN_PIN, GPIO_DIR_OUT);
        mt_set_gpio_out(CAMERA_IMX135_EN_PIN, 1);
    ...
    else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_IMX135_MIPI_RAW_TRULY,currSensorName))) //LINE<JIRA_ID><DATE20130523><IMX135>zenghaihui
    {
        PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_IMX135_MIPI_RAW_TRULY, \n");
        //enable active sensor
        //RST pin
        if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
            #if 0
    ...
    else
    {
        ...
        {
            PK_DBG("[ON_general 1.8V]sensorIdx:%d \n",SensorIdx);
            if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_D2, VOL_1800,mode_name))//LINE <> <DATE20130520> <ov5647 DOVDD 1.8V> wupingzhou
            {
                PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
                //return -EIO;
                //goto _kdCISModulePowerOn_exit_;
...
//LINE<JIRA_ID><DATE20130905><BUG_INFO>zenghaihui
#if 0
        //DVDD
        if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_D, VOL_1500,mode_name))
        {
        ...
        mt_set_gpio_mode(CAMERA_IMX135_EN_PIN, 0);
        mt_set_gpio_dir(CAMERA_IMX135_EN_PIN, GPIO_DIR_OUT);
        mt_set_gpio_out(CAMERA_IMX135_EN_PIN, 0);
        ...
        {
			PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_IMX135_MIPI_RAW_TRULY \n");
