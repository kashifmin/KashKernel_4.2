...
#define MAX_CHARGE_TEMPERATURE  61 //50
#define MIN_CHARGE_TEMPERATURE  -1 // -17 //0
#define ERR_CHARGE_TEMPERATURE  0xFF

//LINE<JIRA_ID><DATE20130826><Disable re-charge>zenghaihui
#define RE_CHARGE_TEMPERATURE   55   //add by panchenjun for re-charge
#define RE_CHARGE_MINTEMPERATURE   0  //add by panchenjun for re-charge

//LINE<JIRA_ID><DATE20130826><High bat>zenghaihui
/**************************************************************************************
*高压电池充电建议
*在0~15℃下可以 使用500mA 直接充满电，4.35V后恒压充电至终止电流0.02C
*在16~45℃下可以使用最大0.5C（1175mA）直接充满电，4.35V后恒压充电至终止电流0.02C
*在45~60℃下可以使用不超过0.3C（705Ma）电流充电，4.0V后恒压充电至终止电流0.02C
*0度以下，60度以上需要禁止充电
*9311 TEMPERATURE <16 || TEMPERATURE > 45, 限流USB 500mA, 正常1A
*0, 60   高低温报警
**************************************************************************************/
#define MAX_NORMAL_CHARGE_TEMPERATURE   46
#define MIN_NORMAL_CHARGE_TEMPERATURE   15
...
//LINE<JIRA_ID><DATE20130530><4.35V bat support>zenghaihui
