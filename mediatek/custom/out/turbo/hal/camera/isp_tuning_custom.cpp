...
#include "kd_imgsensor.h"//LINE <> <DATE20130517> <truly ov5647 tuning para 0517> wupingzhou
...
//                   THH2  TH2  THL2                   THH1  TH1  THL1
    ...
    MINT32 const TH2	= (THL2+THH2)/2;//(THL2 +THH2)/2    4914
    MINT32  TH4			= 100;	//20130103 Jouny    
    MINT32  TH3			= -30;	//20130103 Jouny

	UINT32 sensorID;//BEGIN <> <DATE201304015> <sunny MTM ov8825 tuning para 0413> wupingzhou

	MY_LOG("[8 evaluate_Shading_CCT_index] CCT:%d DF_IDX:%d i4PT:%d i4PW:%d\n",i4CCT,i4DFIDX,i4PT,i4PW);  
	
//BEGIN <> <DATE20130517> <truly ov5647 tuning para 0517> wupingzhou
    sensorID = getSensorID();
	if(sensorID == OV5647MIPI_SENSOR_ID)
	{
		TH3	= -20;
		LOGD("[-evaluate_Shading_CCT_index][OV5647MIPI] This is OV5647MIPI module.");
	}
	else
	{
		LOGD("[-evaluate_Shading_CCT_index][OV5647MIPI] This is other module.");

	}
//END <> <DATE20130517> <truly ov5647 tuning para 0517> wupingzhou
