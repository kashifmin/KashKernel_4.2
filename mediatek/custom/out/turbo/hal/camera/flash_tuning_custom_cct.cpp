...
int getDefaultStrobeNVRam(int sensorType, void* data, int* ret_size)
{
	...
	//tuning para
	p->tuningPara[0].yTar = 180;
	p->tuningPara[0].antiIsoLevel = -5;
	p->tuningPara[0].antiExpLevel = -5;
	p->tuningPara[0].antiStrobeLevel = -10;
	p->tuningPara[0].antiUnderLevel = 5;// -2//LINE <ASNTZO-60> <DATE20130325> <enhance the brightness of flash light> wupingzhou
	p->tuningPara[0].antiOverLevel = -5; //   2//LINE <ASNTZO-60> <DATE20130325> <enhance the brightness of flash light> wupingzhou
	p->tuningPara[0].foregroundLevel = 1;
	p->tuningPara[0].isRefAfDistance = 0;
	p->tuningPara[0].accuracyLevel = -10;

	p->tuningPara[1].yTar = 180;
	...
	p->tuningPara[1].antiOverLevel = -5; //   2//LINE <ASNTZO-60> <DATE20130325> <enhance the brightness of flash light> wupingzhou
	p->tuningPara[1].foregroundLevel = 1;
	p->tuningPara[1].isRefAfDistance = 0;
	p->tuningPara[1].accuracyLevel = -10;

	p->tuningPara[2].yTar = 180;
	...
	p->tuningPara[2].antiOverLevel = -5; //   2//LINE <ASNTZO-60> <DATE20130325> <enhance the brightness of flash light> wupingzhou
	p->tuningPara[2].foregroundLevel = 1;
	p->tuningPara[2].isRefAfDistance = 0;
	p->tuningPara[2].accuracyLevel = -10;

	p->tuningPara[3].yTar = 180;
	...
	p->tuningPara[3].antiOverLevel = -5; //   2//LINE <ASNTZO-60> <DATE20130325> <enhance the brightness of flash light> wupingzhou
