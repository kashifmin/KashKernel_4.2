...
const NVRAM_LENS_PARA_STRUCT FM50AF_TRULY_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        // -------- AF ------------
         { 55, // i4Offset
          ...
          15, // i4THRES_MAIN;
          10, // i4THRES_SUB;            
          5,  // i4INIT_WAIT; Jiangde
          {0, 0, 500, 500, 500}, // i4FRAME_WAIT
          1,  // i4DONE_WAIT;
              
          -1,  // i4FAIL_POS; Jiangde
...
// ------------------------------------------------------------------------           
          ...
          {0, 200, 300, 400, 500}, // back jump Jiangde
          500,  //i4BackJumpPos Jiangde
...
UINT32 FM50AF_getDefaultData_truly(VOID *pDataBuf, UINT32 size) // LINE <><20130709><for truly len> Jiangde
{
    ...
    memcpy(pDataBuf, &FM50AF_TRULY_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM50AF_getDefaultData_truly = FM50AF_getDefaultData_truly; // LINE <><20130709><for truly len> Jiangde
