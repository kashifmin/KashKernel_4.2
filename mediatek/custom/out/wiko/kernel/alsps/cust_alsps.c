...
//    .als_value  = { 1,  3,  16,  51,  586,  638,  1226,  1636, 10243, 10243, 10243, 10243, 10243, 10243, 10243},
    ...
    .als_value  = { 1,  1,  1,  51,  586,  638,  1636,  1636, 10243, 10243, 10243, 10243, 10243, 10243, 10243},
    
    .ps_threshold = 2,	//3,
    .ps_threshold_high = 0x300,	//0x13E,//0x3a,//0x1F//LINE<JIRA_ID><DATE2013117><ps parameter modify>zhuxiankun
    .ps_threshold_low = 0x150,	//0xD1,//0x14,//0x18//LINE<JIRA_ID><DATE2013117><ps parameter modify>zhuxiankun
