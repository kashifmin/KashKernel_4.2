...
void OV12830PreviewSetting(void)
{
	...
	OV12830_write_cmos_sensor(0x380e,0x06);
...
{
	OV12830DB("OV12830VideoSetting/6M_16:9 exit :\n ");
}
...
void OV12830CaptureSetting(void)
{
	...
	OV12830_write_cmos_sensor(0x3090,0x02);
	OV12830_write_cmos_sensor(0x3091,0x15);
	OV12830_write_cmos_sensor(0x30b3,0x6e);
